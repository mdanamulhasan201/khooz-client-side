    ...
    return (
        <div className=' p-4'>
            <div className='w-full grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 gap-6 ' >
                {
                    wishlist.map((p, i) => <div key={i} className='border  w-80  group transition-all duration-500 hover:shadow-md hover:-mt-3'>
                        <div className='relative overflow-hidden'>
                            ...
                            <img className='h-[240px]' src={p.image} alt="Refrigerator Compressor Spare Part" />
