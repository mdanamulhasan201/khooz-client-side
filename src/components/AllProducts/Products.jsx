        ...
        <div>
            ...
            <div className='w-full grid grid-cols-1 xs:grid-cols-1 sm:grid-cols-1 justify-items-center md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-5'>
                {products.map((product, i) => (
                    <div key={i} className='border rounded-lg w-72 group transition-all duration-500 hover:shadow-md hover:-mt-3'>
                        <div className='relative overflow-hidden'>
                            ...
                            <img className='h-[240px] w-72 rounded-t-lg' src={product.images[1]} alt={product.name} />
