...
const Footer = () => {
    return (
        ...
        >
            ...
            <footer className="footer max-w-screen-xl mx-auto px-10 py-4 border-t  text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Khooz Service Provider. <br />Providing reliable tech since 2023</p>
                </div>
